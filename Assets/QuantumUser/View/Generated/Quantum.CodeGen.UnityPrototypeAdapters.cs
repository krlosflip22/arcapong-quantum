...
namespace Quantum.Prototypes.Unity {
  ...
  [System.SerializableAttribute()]
  public unsafe partial class PowerUpStructPrototype : Quantum.QuantumUnityPrototypeAdapter<Quantum.Prototypes.PowerUpStructPrototype> {
    public Quantum.QEnum32<PowerUpType> Type;
    public Int32 BlockIndex;
    public Quantum.QuantumEntityPrototype Owner;
    public FP Time;
    partial void ConvertUser(Quantum.QuantumEntityPrototypeConverter converter, ref Quantum.Prototypes.PowerUpStructPrototype prototype);
    public override Quantum.Prototypes.PowerUpStructPrototype Convert(Quantum.QuantumEntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.PowerUpStructPrototype();
      converter.Convert(this.Type, out result.Type);
      converter.Convert(this.BlockIndex, out result.BlockIndex);
